...
var h = require('pull-hyperscript') // NB currently only on git-ssb
...
function renderRepoTree(req, repo, rev, path) {
  ...
  // Problem here with the pull-map

    //h('table', {class: "files w-100"}, sourceMap(source, file =>
      //h('tr', [
        //h('td', {}, 'yes'),
        //h('td', {}, 'no')
        ////h('td', [
        ...
        ////h('td', [
          ////'cat'
          ////u.link(filePath(file), file.name)
        ////])
      //])
    //))
